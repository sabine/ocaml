...
/* platform dependent best-effort OS thread naming */
#define MAX_OS_THREAD_NAME_LENGTH 16
extern void caml_os_thread_getname(char* name);
extern void caml_os_thread_setname(const char* name);
